    ...
    <div className="relative min-h-[90vh] bg-gradient-to-tr from-blue-600 via-purple-600 to-indigo-800 dark:from-slate-900 dark:via-purple-950 dark:to-slate-950 overflow-hidden">
      ...
      <div className="relative px-4 py-24 text-center flex flex-col items-center justify-center min-h-[90vh] backdrop-blur-sm">
        ...
        >
          ...
          >
            Join thousands of learners from around the globe and transform your
            career with our expert-led courses
          </motion.p>

          <motion.div
            className="flex flex-col items-center justify-center gap-4 mb-6 px-4 w-full max-w-md mx-auto"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.6 }}
          >
            <Button 
              className="rounded-full text-white bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 px-8 py-7 w-[280px] h-16 text-base transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-indigo-500/25"
          ...
          >
            <Button
              onClick={onExplore}
              className="rounded-full bg-white dark:bg-slate-900 text-indigo-700 dark:text-white hover:bg-blue-50 dark:hover:bg-slate-800 px-8 py-7 w-[280px] h-16 text-base transition-all duration-300 hover:scale-105 shadow-lg group"
            >
          ...
          >
            {[
              ...
              >
                ...
                <p className="text-gray-200 dark:text-gray-300 text-sm font-medium mt-1">
                  {stat.label}
                </p>
              </motion.div>
            ))}
